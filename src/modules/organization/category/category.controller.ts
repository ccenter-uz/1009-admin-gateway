...
export class CategoryController {
  ...
  async getListOfCategory(@Query() query: ListQueryDto): Promise<CategoryInterfaces.Response[]> {
  ...
  @ApiParam({ name: 'id' })
  @HttpCode(HttpStatus.OK)
  async getById(@Param('id', ParseIntPipe) id: number): Promise<CategoryInterfaces.Response> {
  ...
  async create(@Body() data: CategoryCreateDto): Promise<CategoryInterfaces.Response> {
  ...
  @Put(':id/restore')
  @HttpCode(HttpStatus.OK)
  async restore(@Param('id', ParseIntPipe) id: number): Promise<CategoryInterfaces.Response> {
